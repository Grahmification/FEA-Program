...
namespace FEA_Program.Models
{
    internal interface IElement
    {
        ...
        DenseMatrix StressMatrix(List<double[]> nodeCoordinates, DenseMatrix globalNodeQ, double[]? intrinsicCoords = null);

        DenseMatrix K_Matrix(List<double[]> nodeCoordinates); // node 1 displacement comes first in disp input, followed by second
